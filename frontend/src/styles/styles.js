const styles = {
    ...
    button: 'w-[150px] bg-[#854d0e] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    ...
    landsTitle: 'text-[25px] font-[600] font-Roboto text-[#333]',
    landActualPrice:"font-bold text-[18px] text-[#333] font-Roboto",
  };
